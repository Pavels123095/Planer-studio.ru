        ...
        <section class="planer-case-section planer-main-section-top planer-layout-section">
            <div class="planer-wrapper-main-section-top">
                ...
                <div class="planer-case-wrapper planer-layout-container">
                    ...
                    ?>
                    <a href="<?php the_permalink(); ?>" class="planer-case-item">
                        <div class="planer-case-description">
                            <?php the_content(); ?>
                        </div>
                        <?php 
                ...
                <div class="planer-case-bottom">
                    <a class="planer-btn-case-all">больше кейсов</a>
                </div>
            </div>
        </section>
    </main>
