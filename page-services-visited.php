            ...
            <section class="planer-main-section-top planer-layout-section">
                <div class="planer-wrapper-main-section-top planer-layout-container">
                    ...
                    <div class="planer-main-wrapper planer-layout-container">
                        ...
                        <div class="planer-description-visited-site">
                            <?php the_content(); ?>
                        </div>
                    ...
                    <div class="planer-back">
                        ...
                        <div class="planer-boy"><img src="<?php echo get_template_directory_uri();?>/assets/img/a2menwoman.png" alt=""></div>
                        <?php the_grass_planer(); ?>
                    </div>
                </div>
            </section>
        </main>
        <section class="planer-visited-section planer-layout-section">
                ...
                <div class="planer-visited-content-second-wrapper planer-main-wrapper planer-layout-container">
                    ...
                    <div class="planer-visited-content-allow">
                        ...
                        <ul class="planer-ul-visited-about">
                            <li>
                                <span class="planer-li-before"><i class="fas fa-check"></i></span>
